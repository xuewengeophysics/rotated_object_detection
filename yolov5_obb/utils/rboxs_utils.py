...
if __name__ == '__main__':
    # polys = np.array([[240.0, 593.0, 206.0, 622.0, 191.0, 605.0, 225.0, 576.0]])
    #wx print(x, y , w, h, angle, theta)
    #wx 5+ cx = 5.0, cy = 2.5, w = 5.0, h = 10.0, angle = 90.0
    #wx LE cx = 5.0, cy = 2.5, w = 10.0, h = 5.0, angle = 90.0, theta = 0.0
    # polys = np.array([[0, 0, 10, 0, 10, 5, 0, 5]])
    #wx 5+ cx = 2.5, cy = 5.0, w = 10.0, h = 5.0, angle = 90.0
    #wx LE cx = 2.5, cy = 5.0, w = 10.0, h = 5.0, angle =  0.0, theta = -pi / 2
    # polys = np.array([[0, 0, 5, 0, 5, 10, 0, 10]])
